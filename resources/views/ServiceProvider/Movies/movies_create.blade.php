                        ...
                        <div class="col-md-12">
                            <div class="table-responsive table-responsive-data2">
                                <div class="col-md-12 col-lg-12">
                                    <h3 class="title-5 m-b-35">Create Movies</h3>

                                    <form class="needs-validation" action="{{ route('movie.store') }}" method="Post" enctype="multipart/form-data">
                                    @csrf 
                                    <div class="row lg-3">
                                        <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" id="genre" name="genre"  placeholder="Enter Movie Category" value="" required>
                                            <div class="invalid-feedback">
                                              Valid Genre.
                                            </div>
                                          </div>
                                          ...
                                          <div class="col-sm-4">
                                            ...
                                            <input type="" class="form-control" id="releasing_year" name="releasing_year" placeholder="Enter Movie Reasing Year" value="" required>
                                            <div class="invalid-feedback">
                                              Releasing year.
                                            </div>
                                          </div>
                                          <div class="col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="total_minutes" id="total_minutes" placeholder="" value="" required>
                                            <div class="invalid-feedback">
                                              Valid total minutes.
                                            </div>
                                          </div>
                                        ...
                                        <div class="col-12">
                                          ...
                                          <textarea  id="description" class="form-control col-12" name="description" cols="30" rows="10"></textarea>
                                          <div class="invalid-feedback">
