...
@section('content')
  ...
  <header class="header">
	...
	<!-- end filter -->
	<h1 class="filter__item-label" id="demo1" ></h1>
	<h1 class="filter__item-label" id="demo2" ></h1>
	<h1 class="filter__item-label" id="demo3" ></h1>
	<h1 class="filter__item-label" id="demo4" ></h1>
	<script>
	function myFunction() {
							...
							<div class="card">
								<div class="card__cover">
									...
									<a href="{{ route('detail.show',$m->id) }}" class="card__play">
										<img src="http://127.0.0.1:8000/img/book2.png" alt="">
									</a>
								</div>
...
<div class="catalog">
		<div class="container">
			<div class="row">
				<div class="col-12">	
				<h1 class="card__title">Movies Not Found / Nothing Found</h1>	
				</div>
		    </div>
       </div>
</div>
